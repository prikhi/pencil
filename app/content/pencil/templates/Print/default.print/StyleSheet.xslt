...
<xsl:output method="html"/>
    ...
    <xsl:template match="p:Page">
        <div class="Page" id="{p:Properties/p:Property[@name='fid']/text()}_page">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="{p:Properties/p:Property[@name='width']/text()}" height="{p:Properties/p:Property[@name='width']/text()}">
                <g xmlns="http://www.w3.org/2000/svg" inkscape:label="{p:Properties/p:Property[@name='name']/text()}"
