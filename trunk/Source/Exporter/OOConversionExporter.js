...
Pencil.registerDocumentExporter(new OOConversionExporter("PDF Document", "PDFExporter", "application/pdf", "Adobe PDF Files (*.pdf)", "*.pdf"));
Pencil.registerDocumentExporter(new OOConversionExporter("Microsoft Word Document (DOC file)", "DOCExporter", "application/msword", "Microsoft Word 97/XP (*.doc)", "*.doc"));
